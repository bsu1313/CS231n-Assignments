...
class ThreeLayerConvNet(object):
    ...
    def __init__(
        ...
        # after pooling, the shape is N, F, 32/2, 32/2
        # so affine layer input dimension becomes N*F*16*16
        IN = num_filters * input_dim[1]//2 * input_dim[2]//2

        
        self.params['W2'] = weight_scale*np.random.randn(IN, hidden_dim)
